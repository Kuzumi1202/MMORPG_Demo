...
namespace Services
{
    internal class ItemService : Singleton<ItemService>
    {
        public ItemService()
        {
            ...
            MessageDistributer.Instance.Subscribe<ItemEquipResponse>(this.OnEquipItem);
        }

        public void Dispose()
        {
            MessageDistributer.Instance.Unsubscribe<ItemBuyResponse>(this.OnItemBuy);
            MessageDistributer.Instance.Unsubscribe<ItemEquipResponse>(this.OnEquipItem);
        }
        ...
        public bool SendEquipItem(Item equip, bool isEquip)
        {
            ...
            message.Request.itemEquip.Solt = (int)equip.EquipInfo.Slot;
        ...
        private void OnEquipItem(object sender, ItemEquipResponse message)
        {
