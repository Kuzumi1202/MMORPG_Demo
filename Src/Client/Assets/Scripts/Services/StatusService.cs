...
namespace Services
{
    internal class StatusService : Singleton<StatusService>, IDisposable
    {
        ...
        private Dictionary<StatusType, StatusNotifyHandler> eventMap = new Dictionary<StatusType, StatusNotifyHandler>();
        ...
        {
            Debug.LogFormat("",status.Type,status.Action,status.Id,status.Value);
